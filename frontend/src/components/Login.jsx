      ...
      <div className="relative z-10 w-full max-w-md px-6 py-12 bg-white bg-opacity-80 rounded-lg shadow-xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Sign In
            </button>
          </div>
